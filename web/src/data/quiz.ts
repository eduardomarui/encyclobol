...
export const quiz: QuizQuestion[] = [
  ...
  { q: 'Quais países sediam a Copa do Mundo de 2026?', options: ['EUA, México e Canadá', 'Brasil', 'Espanha e Portugal', 'Catar'], correct: 0, cat: 'Copas', dif: 'facil' },
  ...
  { q: 'Qual seleção venceu a Copa do Mundo de 1954?', options: ['Alemanha', 'Hungria', 'Brasil', 'Uruguai'], correct: 0, cat: 'Copas', dif: 'dificil' },
  { q: 'Qual seleção venceu a Copa do Mundo de 1934?', options: ['Itália', 'Tchecoslováquia', 'Áustria', 'Hungria'], correct: 0, cat: 'Copas', dif: 'dificil' },
  { q: 'Qual seleção venceu a Copa do Mundo de 1938?', options: ['Itália', 'Hungria', 'Brasil', 'Alemanha'], correct: 0, cat: 'Copas', dif: 'dificil' },
